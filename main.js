       ...
       $(this).next().slideToggle();
            ...
            $(document).ready(function() {
                ...
                function makeTimer() {
                  ...
                  $(".time .days").html("<span>D </span>" + days);
                  $(".time .hours").html("<span>H </span>" + hours);
                  $(".time .minutes").html("<span>M </span>" + minutes);
                  $(".time .seconds").html("<span>S </span>" + seconds);
                }
